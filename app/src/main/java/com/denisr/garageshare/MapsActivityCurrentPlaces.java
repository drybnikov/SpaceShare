...
public class MapsActivityCurrentPlaces extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.menu_select_location);
        getSupportActionBar().setHomeButtonEnabled(true);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_select_loaction, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                finish();
                return true;
            case R.id.action_set_place:
                Intent result = new Intent().putExtra(EXTRA_LOCATION, mCurrentLocation);
                result.putExtra(EXTRA_LOCATION_DESC, mCurrentLocation);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker marker) {
                ...
                Log.d(TAG, "getInfoContents marker:" + marker.getTitle() + "," + marker.getPosition());
